...
<head>
    ...
    <title class="has_page_title">Page not found</title>
                    ...
                    <div class="row py-3 text-center justify-content-center">
                        <div class="col-12 col-md-10">
                            <div class="text-cover-wrapper">
                                <h3 class="text-cover-title c-white">503</h3>
                                <h4 class="text-cover-subtitle c-white strong-400 mt-4">Service Unavailable</h4>
