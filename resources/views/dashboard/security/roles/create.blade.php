    ...
    <section id="main_content" class="bg slice-sm sct-color-1">
        <div class="container" id="container">
            ...
            <div class="breadcrumb-pageheader p-b-25">
                ...
                <h6 class="sm-pagetitle--style-1 has_page_title">New role</h6>
            </div>
            <!--END BREADCRUMB-->
                        ...
                        <div class="col-lg-12">
                            <div class="sm-wrapper" >
                                ...
                                <div class="sm-box px-4">
                                    <div class="sm-info">
                                        <div class="sm-info-with-icon">
                                            ...
                                            <div class="sm-info-text">
                                                <h5 class="sm-inner-header">Creating new role</h5>
                                                <div class="sm-inner-desc">
                                                    Choose new role name and assign page permissions (with read or write access) to new role.
                                                    <br>
                                                    <br>
                                                    <b>NOTES:</b>
                                    ...
                                    <form action="{{ route('tenant:roles.store',['tenant'=>session('tenant')]) }}" class="form-default" method="POST">
                                        @csrf

                                        <div class="row mb-3">
                                            <div class="col-lg-12 sm-form-design">
                                                <input type="text" name="name" id="inputName" class="form-control" placeholder="Please enter name of role" value="{{ old('name') }}" tabindex="1" maxlength="35" required="" autocomplete="off">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @foreach(config('custom.permissions') as $key=>$permission)
                                                <div class="col-md-6 d-flex justify-content-between">
                                                    <div class="checkbox">
                                                        <input id="{{ 'permission'.'-'.$key }}" name="permissions[{{ $key }}][read]" type="checkbox"  autocomplete="off">
                                                    ...
                                                    <div>
                                                        <div class="checkbox checkbox-success checkbox-inline">
                                                            <input type="checkbox" id="{{ $key.'-add' }}" value="1"  name="permissions[{{ $key }}][add]" autocomplete="off">
                                                            <label for="{{ $key.'-add' }}">
                                                                Add </label>
                                                        </div>
                                                        <div class="checkbox checkbox-success checkbox-inline">
                                                            <input type="checkbox" id="{{ $key.'-update' }}" value="1"  name="permissions[{{ $key }}][update]" autocomplete="off">
                                                            <label for="{{ $key.'-update' }}">
                                                                Update </label>
                                                        </div>
                                                        <div class="checkbox checkbox-success checkbox-inline">
                                                            <input type="checkbox" id="{{ $key.'-delete' }}" value="1"  name="permissions[{{ $key }}][delete]" autocomplete="off">
                                        ...
                                        <button class="btn btn-primary m-t-5">Create new role</button>
                                    </form>
                                </div>
                            </div>
                        </div>
